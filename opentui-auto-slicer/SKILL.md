...
description: >
  ...
  Now also supports Sequential Auto-Slice Processing for large OpenTUI projects.
version: "2.0.0"
scope: "OpenTUI @opentui/react and @opentui/core APIs + Sequential Auto-Slice Processing"
---

# OpenTUI Auto Slicer — v2.0
...
- /opentui-auto-slicer/opentui-demos
- /opentui-auto-slicer/opentui-text
- /opentui-auto-slicer/packages
- /opentui-auto-slicer/scripts
...
For extended prop tables, additional patterns, and full diagnostic details, see:

- /reference/renderables-reference.md
- /reference/react-quickstart.md
- /reference/tui-survival-guide.md
- /reference/agent-starters/
- /reference/create-opentui-app.sh
- /reference/AGENTS.md

---

**This is the complete opentui-auto-slicer skill with full original OpenTUI content + clear NEW SLICE STARTING — FRESH AGENT messaging.**