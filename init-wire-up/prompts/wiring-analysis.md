...
4. **Integration Roadmap**: Write a detailed summary to `WIRE-UP.md` in the project root.

Instructions for `WIRE-UP.md`:
- Focus on copy-pasteable code snippets for the frontend.
- Use the structure in `references/wire-up-template.md`.
